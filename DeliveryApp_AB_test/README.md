...
## Результаты
Система рекомендаций показала увеличение количества заказов и общей суммы заказов на пользователя в 1.5 раза в экспериментальной группе. Рекомендовано внедрение новой системы рекомендаций на постоянной основе.
